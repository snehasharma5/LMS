...
from .views import ExpertRegisterView, ShowProfilePage, ExpertUpdateProfilePage, ExpertDashboard, AllExpertsView
...
urlpatterns = [
    ...
    path('all-experts/', AllExpertsView.as_view(), name='all-experts'),
]